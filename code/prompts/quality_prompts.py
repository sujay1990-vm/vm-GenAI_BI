...
COLUMNS:
 ...
 - MedicalEventDateMonthOfQuarter (string): The months position within the quarter. [Example: True]
 ...
 - MedicalEventDateYear (string): The calendar year [Example: '1961', '2024']
...
3. Fall Count : MedicalEventTypeGroup = 'Fall', **DO NOT USE MedicalEventTypeName **
"""
